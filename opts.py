...
def get_args_parser():
    ...
    # glip related setting
    parser.add_argument('--use_glip', default=False, action='store_true', help='whether to use glip as image/language backbone')
    parser.add_argument('--glip_checkpoint', default='', type=str, help='resume backbone weights from glip checkpoint')
    ...
    parser.add_argument('--tb_split', default='pre-train-loss', type=str,
                        help='number of distributed processes')

    parser.add_argument('--booster_checkpoint', default='', type=str, help='resume backbone weights from glip checkpoint')
    parser.add_argument('--booster_config_file', default='', type=str, help='glip config file')
