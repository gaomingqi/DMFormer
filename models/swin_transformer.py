...
from .swint import SwinTransformer as swin_glip
from .swint import build_swint_backbone
...
class BackboneBase(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor, lang_dict):
        xs = self.body(tensor_list.tensors, lang_dict)
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        if use_glip:
            # backbone = swin_glip()
            backbone = build_swint_backbone()
            backbone.init_weights(glip_checkpoint)
        else:
...
class Joiner(nn.Sequential):
    ...
    def forward(self, tensor_list: NestedTensor, lang_dict):
        ...
        xs = self[0](tensor_list, lang_dict)
...
def build_swin_backbone(args):
    ...
    backbone = Backbone(args.backbone, args.use_glip, args.glip_checkpoint, args.use_checkpoint, args.backbone_pretrained)
