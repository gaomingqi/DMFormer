...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, memory, tgt, masks, pos_embeds, query_embed=None):
        ...
        spatial_shapes = torch.as_tensor(spatial_shapes, dtype=torch.long, device=mask_flatten.device)
